...
For a detailed rationale, please consult [Rationale](/docs/systems/overlays/system-rationale/).
...
We also export a few [preset configuration objects](/docs/systems/overlays/system-configuration/).
